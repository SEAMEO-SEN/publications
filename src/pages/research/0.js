          ...
          <CardContent>
            <Typography component={"div"}>
              <Typography component={"div"} variant="h6">
                Penggunaan Brailtex Bagi Meningkatkan Penguasaan Kemahiran
                Menulis Kod Braille Menggunakan Slate Dan Stylus
              </Typography>
              ...
              <Typography
                ...
                gutterBottom
              >
                Kway Eng Hock, Pau Kee, Nurbieta Binti Abdul Aziz, Shahida Binti
                Hashim
              </Typography>
            </Typography>
            <Typography component={"div"} variant="body1">
            ...
            <Typography className={classes.oblique}>{abstract}</Typography>
          </CardContent>
          <CardActions>
            <Button
              size="large"
